...
if issue != '<select>' or caseTitle !='<select>':
    ...
    '''# Select your Fantasy SCOTUS:'''

    judge1 = st.selectbox('Select your Chief Justice', judgeSelects,index=32)
    judge2 = st.selectbox('Select Associate Justice 1', judgeSelects,index=29)
    judge3 = st.selectbox('Select Associate Justice 2', judgeSelects, index=30)
    judge4 = st.selectbox('Select Associate Justice 3', judgeSelects, index=31)
    judge5 = st.selectbox('Select Associate Justice 4', judgeSelects, index=33)
    judge6 = st.selectbox('Select Associate Justice 5', judgeSelects, index=34)
    judge7 = st.selectbox('Select Associate Justice 6', judgeSelects, index=35)
    judge8 = st.selectbox('Select Associate Justice 7', judgeSelects, index=36)
    judge9 = st.selectbox('Select Associate Justice 8', judgeSelects, index=37)
    st.text("")
    st.text("")
